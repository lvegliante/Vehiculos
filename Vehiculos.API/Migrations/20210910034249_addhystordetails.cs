...
{
    public partial class addhystordetails : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehiculoTypeId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vehicles_VehiculoTypes_VehiculoTypeId",
                        column: x => x.VehiculoTypeId,
                        principalTable: "VehiculoTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_VehiculoTypeId",
                table: "Vehicles",
                column: "VehiculoTypeId");
        }
